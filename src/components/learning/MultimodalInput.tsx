...
import type { InputModality } from "@/types/api.types";

interface MultimodalInputProps {
  onSubmit: (content: string, modality: InputModality, rawData?: string) => void;
  isLoading?: boolean;
  disabled?: boolean;
  placeholder?: string;
}
...
export const MultimodalInput = ({
  ...
  return (
    <Card className="glass-card p-4">
      <Tabs
        value={activeTab}
        onValueChange={(v) => setActiveTab(v as InputModality)}
        className="w-full"
      >
